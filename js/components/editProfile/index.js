...
var DEFAULT_URL = 'https://playopentennis.com/uk/login';
      ...
      return (
          <Container theme={theme} style={{backgroundColor: theme.defaultBackgroundColor}}>
              <Header style={{justifyContent: 'flex-start', height:(Platform.OS==='ios') ? 60 : 45}}>
                  <Button transparent onPress={() => this.navigateTo('profile')} style={{marginLeft: -10}}>
...
export default connect(null, bindAction)(EditProfile);
